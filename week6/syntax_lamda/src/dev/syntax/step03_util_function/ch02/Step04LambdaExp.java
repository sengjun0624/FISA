...
public class Step04LambdaExp {
	...
	public static void main(String[] args) {
		...
		List<Employee> employeesInFs = getAllEmployeesFilteredBy((Employee employee) -> {
		...
		List<Employee> employeesInMs = getAllEmployeesFilteredBy((Employee employee) -> {
		...
		List<Employee> javaDevelopers = getAllEmployeesFilteredBy((Employee employee) -> {
		...
		List<Employee> seniors = getAllEmployeesFilteredBy((Employee employee) -> {
