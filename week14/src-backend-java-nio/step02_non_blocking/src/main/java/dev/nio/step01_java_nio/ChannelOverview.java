 ...
 *
 java.nio.channels 패키지(https://docs.oracle.com/javase/8/docs/api/java/nio/channels/package-summary.html)
 *
 * 파일 및 소켓과 같이 I/O 작업을 수행할 수 있는 엔티티에 대한 연결을 수행하는 역할인 Channel 클래스를 정의,
 * 또한 다중화된(multiplexed) 논블로킹 I/O 작업을 위한 Selector 클래스를 정의함
 *
   SelectableChannel
